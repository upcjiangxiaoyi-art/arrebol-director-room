...
/*
 * Arrebol Director Room 暗河红霞 Arrebol D v1.0.3.3
 * 抽屉内嵌稳定版：
 * - 情感导演 / 剧情导演 双页面
 * - 双 API / 双模型 / 双预设
 * - 拉取模型
...
(function () {
    ...
    var EXT = "arrebol-d-final-v1033-tap-drag-fix";
    ...
    function drawerHTML() {
        ...
        return '<div id="adr044-drawer"><div class="inline-drawer">'
            + '<div class="inline-drawer-toggle inline-drawer-header"><b>🎬 Arrebol D 暗河红霞导演系统 v1.0.3.3</b><div class="inline-drawer-icon fa-solid fa-circle-chevron-down down"></div></div>'
    ...
    function adr048PanelHTML() {
        ...
        return '<div id="adr048-popup-panel" data-open="0">'
            ...
            + '<div class="adr048-note">暗河红霞 Arrebol D 已就绪。情感/剧情可分别设置自动触发间隔；小红霞轻点打开，拖动不打开。</div>'
